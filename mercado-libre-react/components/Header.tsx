...
const Header = () => {
    ...
    return (
        <>
            <header className='w-screen bg-yellow lg:h-[100px] h-14 flex justify-center text-gray-dark'>
                <nav className="flex justify-center w-full lg:h-full h-12">
                    <div className="w-4/5 lg:h-[92px] h-12 flex flex-col gap-y-2 text-13px">
                        <div className='flex flex-row gap-x-[52px] items-center'>
                            ...
                            <div className='lg:hidden text-28px'>
                                <button onClick={() => {
                            ...
                            <div className='grid grid-cols-1 justify-center lg:hidden w-11'>
                                <div className='flex row-span-full col-start-1 col-span-1 self-center justify-center'>
                                ...
                                <div className='flex row-span-full col-start-1 col-span-1 justify-center'>
